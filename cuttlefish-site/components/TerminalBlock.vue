<template>
  <div class="relative group">
    ...
    <div class="bg-slate-950 border border-slate-700 rounded-lg overflow-hidden">
      ...
      <div class="p-4 font-mono text-sm">
        ...
        <div v-if="comment" class="text-slate-500 mb-1">
          <span class="text-slate-600"># </span>{{ comment }}
        </div>
    ...
    <button
      ...
      class="absolute top-10 right-2 p-2 rounded bg-slate-800 hover:bg-slate-700 border border-slate-600 opacity-0 group-hover:opacity-100 transition-all"

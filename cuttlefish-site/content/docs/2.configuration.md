...
|----------|----------|-------------------|
| `deep` | Complex reasoning, autonomous execution | Claude Sonnet 4.6, Claude Opus 4.6 |
| `quick` | Simple tasks, fast responses | Claude Haiku 4.5 |
| `ultrabrain` | Hard logic, architecture decisions | Claude Opus 4.6 |
| `visual` | Frontend, UI/UX, design work | Gemini 2.0 Flash |
| `unspecified-high` | General tasks, higher effort | Claude Sonnet 4.6 |
| `unspecified-low` | General tasks, lower effort | Claude Haiku 4.5 |

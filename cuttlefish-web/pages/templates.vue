...
const fetchTemplates = async () => {
  ...
  try {
    ...
    // TODO: Remove mock data once API is implemented
...
// Mock templates for development (TODO: Remove when API is ready)
const getMockTemplates = (): Template[] => [
  {
    id: 'rust-cli',
    name: 'Rust CLI',
    description: 'Command-line application with argument parsing, logging, and error handling',
    fullDescription: 'A production-ready Rust CLI template with structured logging, clap for argument parsing, and comprehensive error handling using thiserror. Includes CI/CD configuration and release automation.',
    language: 'Rust',
    category: 'CLI',
    tags: ['rust', 'cli', 'argument-parsing', 'logging'],
    useCount: 142,
    stars: 89,
    updatedAt: '2025-03-15T10:30:00Z',
    sourceUrl: 'https://github.com/example/rust-cli-template',
    fileStructure: `.
├── src/
│   ├── main.rs
│   ├── cli.rs
...
└── README.md`
  },
  {
    id: 'rust-lib',
    name: 'Rust Library',
    description: 'Library with tests, documentation, and CI/CD pipeline',
    fullDescription: 'A well-structured Rust library template with comprehensive test coverage, documentation generation via rustdoc, and automated CI/CD using GitHub Actions.',
    language: 'Rust',
    category: 'Library',
    tags: ['rust', 'library', 'testing', 'documentation'],
    useCount: 98,
    stars: 67,
    updatedAt: '2025-03-10T14:20:00Z',
    sourceUrl: 'https://github.com/example/rust-lib-template',
    fileStructure: `.
├── src/
│   └── lib.rs
├── benches/
...
└── README.md`
  },
  {
    id: 'nuxt-app',
    name: 'Nuxt App',
    description: 'Nuxt 3 web application with Tailwind CSS and dark mode',
    fullDescription: 'Full-stack Nuxt 3 application template with Tailwind CSS styling, dark mode support, and optimized production build configuration.',
    language: 'TypeScript',
    category: 'Web',
    ...
    sourceUrl: 'https://github.com/example/nuxt-app-template',
    fileStructure: `.
├── pages/
├── components/
├── composables/
...
└── package.json`
  },
  {
    id: 'fastapi',
    name: 'FastAPI',
    description: 'Python FastAPI backend with async support and OpenAPI docs',
    fullDescription: 'Production-ready FastAPI template with async database support, automatic OpenAPI documentation, JWT authentication, and Docker deployment.',
    language: 'Python',
    category: 'API',
    ...
    sourceUrl: 'https://github.com/example/fastapi-template',
    fileStructure: `.
├── app/
│   ├── main.py
│   ├── routers/
...
└── docker-compose.yml`
  },
  {
    id: 'discord-bot',
    name: 'Discord Bot',
    description: 'Discord bot starter with slash commands and event handlers',
    fullDescription: 'Modern Discord bot template using discord.py with slash commands, event handlers, and a modular cog architecture for easy extension.',
    language: 'Python',
    category: 'Bot',
    ...
    sourceUrl: 'https://github.com/example/discord-bot-template',
    fileStructure: `.
├── bot/
│   ├── main.py
│   ├── cogs/
...
└── README.md`
  },
  {
    ...
    description: 'Go microservice with gRPC, Docker, and Kubernetes configs',
    fullDescription: 'Production-grade Go microservice template with gRPC communication, health checks, structured logging, and Kubernetes deployment manifests.',
    language: 'Go',
    category: 'API',
    tags: ['go', 'grpc', 'microservice', 'kubernetes'],
    useCount: 89,
    stars: 72,
    updatedAt: '2025-03-08T08:30:00Z',
    sourceUrl: 'https://github.com/example/go-microservice-template',
    fileStructure: `.
├── cmd/
│   └── server/
├── internal/
...
└── go.mod`
  },
  {
    ...
    fullDescription: 'Isolated React component development template with Storybook for documentation, TypeScript for type safety, and Rollup for bundling.',
    language: 'TypeScript',
    category: 'Library',
    tags: ['react', 'typescript', 'storybook', 'component-library'],
    useCount: 112,
    stars: 85,
    updatedAt: '2025-03-05T13:20:00Z',
    sourceUrl: 'https://github.com/example/react-component-template',
    fileStructure: `.
├── src/
│   ├── components/
│   └── index.ts
...
└── rollup.config.js`
  },
  {
    id: 'nextjs-saas',
    name: 'Next.js SaaS',
    description: 'Full-stack SaaS starter with auth, billing, and dashboard',
    fullDescription: 'Complete SaaS application template with Next.js App Router, authentication via NextAuth, Stripe billing integration, and admin dashboard.',
    language: 'TypeScript',
    category: 'Web',
    tags: ['nextjs', 'saas', 'stripe', 'authentication'],
    useCount: 267,
    stars: 198,
    updatedAt: '2025-03-22T10:00:00Z',
    sourceUrl: 'https://github.com/example/nextjs-saas-template',
    fileStructure: `.
├── app/
│   ├── (auth)/
│   ├── (dashboard)/

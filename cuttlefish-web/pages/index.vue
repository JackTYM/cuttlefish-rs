    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="bg-gray-900 rounded-xl border border-gray-800 p-4 sm:p-6 mb-6">
        ...
        <div class="flex flex-col gap-3">
          ...
          <!-- Template Preview -->
          <div v-if="selectedTemplateInfo" class="mt-2 p-3 bg-gray-800/50 rounded-lg border border-gray-700/50">
      ...
      <div v-if="projects.length" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <NuxtLink
          ...
          class="bg-gray-900 rounded-xl border border-gray-800 p-5 hover:border-cyan-800 transition-colors cursor-pointer group"
        >
          <div class="flex items-start justify-between mb-2">
            <div class="flex items-center gap-2">
              <h3 class="font-semibold text-white group-hover:text-cyan-400 transition-colors">{{ project.name }}</h3>
              <!-- Template Badge -->
              <span
